...
| ClassificationTreeId | Integer | Identifier for a <a href='http://developers.iqmetrix.com/api/classification-tree/#classificationtree'>ClassificationTree</a> | `1` |
...
| GlCostOfSalesAccountNumber | String | Account number for Cost of Sales, see {{support_GLAccountSetup}} for more information | `1001` |
| GlInventoryAccountNumber | String | Account number for Inventory, see {{support_GLAccountSetup}} for more information | `1002` |
| GlInventoryCorrectionsAccountNumber | String | Account number for Inventory Corrections, see {{support_GLAccountSetup}} for more information | `1001` |
| GlSalesAccountNumber | String | Account number for Sales, see {{support_GLAccountSetup}} for more information | `1003` |
...
| PricingMethod | String | See [PricingMethods](#pricingmethods) for a list of acceptable values. Defaults to Fixed | `Fixed` |
| ProductLabel | String | Defaults to first 30 characters of the ProductName, but can be edited | `iPhone 4S 16GB White` |
| ProductTypeId | Integer | Identifier for a [ProductType](#producttype) | `0` |
...
| SourceRowNumber | Integer | If this product was imported from a spreadsheet, the row location of the product in the spreadsheet | `15` |
...
| FloorPrice | Object | Floor pricing allows you to keep a product as Discountable but set a minimum price that it can be sold at to ensure margins.  Will default to 0 and cannot be negative. See {{support_FloorPricing}} for more details. | `0.0` |
...
| Price | Object | Company-wide default unit price, must be greater then 0 | `499.99` |
...
| StoreInStorePrice | Object | Store in Store price. See {{support_StoreInStore}} for more information | `399.99` |
...
| ProductTypeId | Integer | Identifier for a [ProductType](#producttype) | `2` |
...
| ProductTypeId | Integer | Identifier for a [ProductType](#producttype) | `1` |
| Serialized | Boolean | A flag to indicate if this Product is serialized, meaning a serial number must be entered when the Product is purchased. Defaults to false. Once selected, this cannot be changed. | `true` |
| SerialNumberPromptText | String | Text displayed when user is prompted to enter a serial number for the product | `Serial prompt text here` |
...
| ProductTypeId | Integer | Identifier for a [ProductType](#producttype) | `4` |
| Serialized | Boolean | A flag to indicate if this Product is serialized, meaning a serial number must be entered when the Product is purchased. Defaults to false. Once selected, this cannot be changed. | `true` |
| SerialNumberPromptText | String | Text displayed when user is prompted to enter a serial number for the product | `Serial prompt text here` |
...
| CompanyId | Integer | Identifier for a <a href='http://developers.iqmetrix.com/api/company-tree/#company'>Company</a> | `14146` |
| DateCreated | DateTime | Date this Batch was created | `2015-09-14T22:11:16.5670000Z` |
| FailedCount | Integer | Number of products that failled to process | `1` |
| PendingCount | Integer | Number of products pending processing | `1` |
| Products | Array[<a href='/api/epc/#productstatus'>ProductStatus</a>] | Product statuses |  |
| SourceFileName | String | Name of a spreadsheet, if this batch was created from an import | `Products.xslx` |
...
| SuccessfulCount | Integer | Number of products successfully processed | `1` |
| TotalProductCount | Integer | Total number of Products in the Batch | `2` |

### ProductStatus

| Name | Data Type | Description | Example |
|:-----|:----------|:------------|:--------|
| ProductName | String | Product name | `Galaxy Note 6` |
| SourceRowNumber | Integer | If this product was imported from a spreadsheet, the row location of the product in the spreadsheet | `15` |
...
<h3 id='bulk-importing-products-to-rq' class='clickable-header top-level-header'>Bulk Importing Products to RQ</h3>
...
<ul class="nav nav-tabs">
    <li class="active"><a href="#http-bulk-importing-products-to-rq" data-toggle="tab">HTTP</a></li>
    <li><a href="#curl-bulk-importing-products-to-rq" data-toggle="tab">cURL</a></li>
    <li><a href="#csharp-bulk-importing-products-to-rq" data-toggle="tab">C# (RestSharp)</a></li>
    <li><a href="#java-bulk-importing-products-to-rq" data-toggle="tab">Java (HttpComponents)</a></li>
    <li><a href="#ruby-bulk-importing-products-to-rq" data-toggle="tab">Ruby (rest-client)</a></li>
    <button id="copy-bulk-importing-products-to-rq" class="copy-button btn btn-default btn-sm" data-clipboard-action="copy" data-clipboard-target="#http-code-bulk-importing-products-to-rq"><i class="fa fa-clipboard" title="Copy to Clipboard"></i></button>
</ul>
<div class="tab-content"> 
    <div role="tabpanel" class="tab-pane active" id="http-bulk-importing-products-to-rq">
<pre id="http-code-bulk-importing-products-to-rq"><code class="language-http">POST /companies(1)/products
...
Content-Type: application/json
    ...
    <div role="tabpanel" class="tab-pane" id="curl-bulk-importing-products-to-rq">
<pre id="curl-code-bulk-importing-products-to-rq"><code class="language-http">curl -X POST "https://platformepcdemo.iqmetrix.net/v1/companies(1)/products" -H "Authorization: Bearer (Access Token)" -H "Accept: application/json" -H "Content-Type: application/json" -d '{
    "RegularProducts": [
        {
            "Barcodes": [
                "BARCODE123"
    ...
    <div role="tabpanel" class="tab-pane" id="csharp-bulk-importing-products-to-rq">
        This code sample uses <a href="http://restsharp.org/">RestSharp</a>, ensure you install the nuget package and include <code>Using RestSharp;</code> at the top of your file.
<pre id="csharp-code-bulk-importing-products-to-rq"><code class="language-csharp">static IRestResponse BulkImportingProductsToRq()
{
    ...
    <div role="tabpanel" class="tab-pane" id="java-bulk-importing-products-to-rq">
        This code sample uses <a href="https://hc.apache.org/">Apache HttpComponents</a>, ensure you download and include the required Jars.
<pre id="java-code-bulk-importing-products-to-rq"><code class="language-java">import org.apache.http.entity.StringEntity;
...
public static CloseableHttpResponse BulkImportingProductsToRq() throws IOException {
    ...
    <div role="tabpanel" class="tab-pane" id="ruby-bulk-importing-products-to-rq">
        This code sample uses <a href="https://github.com/rest-client/rest-client">rest-client</a>, ensure you <code>gem install rest-client</code>.
<pre id="ruby-code-bulk-importing-products-to-rq"><code class="language-ruby">require 'rest-client'
...
<h3 id='importing-regular-products-into-rq' class='clickable-header top-level-header'>Importing Regular Products into RQ</h3>
...
<ul class="nav nav-tabs">
    <li class="active"><a href="#http-importing-regular-products-into-rq" data-toggle="tab">HTTP</a></li>
    <li><a href="#curl-importing-regular-products-into-rq" data-toggle="tab">cURL</a></li>
    <li><a href="#csharp-importing-regular-products-into-rq" data-toggle="tab">C# (RestSharp)</a></li>
    <li><a href="#java-importing-regular-products-into-rq" data-toggle="tab">Java (HttpComponents)</a></li>
    <li><a href="#ruby-importing-regular-products-into-rq" data-toggle="tab">Ruby (rest-client)</a></li>
    <button id="copy-importing-regular-products-into-rq" class="copy-button btn btn-default btn-sm" data-clipboard-action="copy" data-clipboard-target="#http-code-importing-regular-products-into-rq"><i class="fa fa-clipboard" title="Copy to Clipboard"></i></button>
</ul>
<div class="tab-content"> 
    <div role="tabpanel" class="tab-pane active" id="http-importing-regular-products-into-rq">
<pre id="http-code-importing-regular-products-into-rq"><code class="language-http">POST /companies(1)/Products
Authorization: Bearer (Access Token)
Accept: application/json
Content-Type: application/json
</code><code class="language-csharp">{
    ...
    <div role="tabpanel" class="tab-pane" id="curl-importing-regular-products-into-rq">
<pre id="curl-code-importing-regular-products-into-rq"><code class="language-http">curl -X POST "https://platformepcdemo.iqmetrix.net/v1/companies(1)/Products" -H "Authorization: Bearer (Access Token)" -H "Accept: application/json" -H "Content-Type: application/json" -d '{
    "RegularProducts": [
        {
            "Barcodes": [
                "BARCODE123"
    ...
    <div role="tabpanel" class="tab-pane" id="csharp-importing-regular-products-into-rq">
        This code sample uses <a href="http://restsharp.org/">RestSharp</a>, ensure you install the nuget package and include <code>Using RestSharp;</code> at the top of your file.
<pre id="csharp-code-importing-regular-products-into-rq"><code class="language-csharp">static IRestResponse ImportingRegularProductsIntoRq()
{
    var client = new RestClient("https://platformepcdemo.iqmetrix.net/v1/companies(1)/Products");
    var request = new RestRequest(Method.POST);
    ...
    <div role="tabpanel" class="tab-pane" id="java-importing-regular-products-into-rq">
        This code sample uses <a href="https://hc.apache.org/">Apache HttpComponents</a>, ensure you download and include the required Jars.
<pre id="java-code-importing-regular-products-into-rq"><code class="language-java">import org.apache.http.entity.StringEntity;
import org.apache.http.client.methods.CloseableHttpResponse;
import org.apache.http.client.methods.HttpPost;
import org.apache.http.impl.client.CloseableHttpClient;
import org.apache.http.impl.client.HttpClients;
...
public static CloseableHttpResponse ImportingRegularProductsIntoRq() throws IOException {
    ...
    <div role="tabpanel" class="tab-pane" id="ruby-importing-regular-products-into-rq">
        This code sample uses <a href="https://github.com/rest-client/rest-client">rest-client</a>, ensure you <code>gem install rest-client</code>.
<pre id="ruby-code-importing-regular-products-into-rq"><code class="language-ruby">require 'rest-client'
...
<h3 id='importing-non-stocked-products-into-rq' class='clickable-header top-level-header'>Importing Non-Stocked Products into RQ</h3>
...
<ul class="nav nav-tabs">
    <li class="active"><a href="#http-importing-non-stocked-products-into-rq" data-toggle="tab">HTTP</a></li>
    <li><a href="#curl-importing-non-stocked-products-into-rq" data-toggle="tab">cURL</a></li>
    <li><a href="#csharp-importing-non-stocked-products-into-rq" data-toggle="tab">C# (RestSharp)</a></li>
    <li><a href="#java-importing-non-stocked-products-into-rq" data-toggle="tab">Java (HttpComponents)</a></li>
    <li><a href="#ruby-importing-non-stocked-products-into-rq" data-toggle="tab">Ruby (rest-client)</a></li>
    <button id="copy-importing-non-stocked-products-into-rq" class="copy-button btn btn-default btn-sm" data-clipboard-action="copy" data-clipboard-target="#http-code-importing-non-stocked-products-into-rq"><i class="fa fa-clipboard" title="Copy to Clipboard"></i></button>
</ul>
<div class="tab-content"> 
    <div role="tabpanel" class="tab-pane active" id="http-importing-non-stocked-products-into-rq">
<pre id="http-code-importing-non-stocked-products-into-rq"><code class="language-http">POST /companies(1)/products/
Authorization: Bearer (Access Token)
Accept: application/json
Content-Type: application/json
</code><code class="language-csharp">{
    ...
    <div role="tabpanel" class="tab-pane" id="curl-importing-non-stocked-products-into-rq">
<pre id="curl-code-importing-non-stocked-products-into-rq"><code class="language-http">curl -X POST "https://platformepcdemo.iqmetrix.net/v1/companies(1)/products/" -H "Authorization: Bearer (Access Token)" -H "Accept: application/json" -H "Content-Type: application/json" -d '{
    "NonStockedProducts": [
        {
            "ProductName": "Prepaid Rate Plan",
            "CategoryName": "Rate Plans > Rate Plans",
    ...
    <div role="tabpanel" class="tab-pane" id="csharp-importing-non-stocked-products-into-rq">
        This code sample uses <a href="http://restsharp.org/">RestSharp</a>, ensure you install the nuget package and include <code>Using RestSharp;</code> at the top of your file.
<pre id="csharp-code-importing-non-stocked-products-into-rq"><code class="language-csharp">static IRestResponse ImportingNon-stockedProductsIntoRq()
{
    var client = new RestClient("https://platformepcdemo.iqmetrix.net/v1/companies(1)/products/");
    var request = new RestRequest(Method.POST);
    ...
    <div role="tabpanel" class="tab-pane" id="java-importing-non-stocked-products-into-rq">
        This code sample uses <a href="https://hc.apache.org/">Apache HttpComponents</a>, ensure you download and include the required Jars.
<pre id="java-code-importing-non-stocked-products-into-rq"><code class="language-java">import org.apache.http.entity.StringEntity;
import org.apache.http.client.methods.CloseableHttpResponse;
import org.apache.http.client.methods.HttpPost;
import org.apache.http.impl.client.CloseableHttpClient;
import org.apache.http.impl.client.HttpClients;
...
public static CloseableHttpResponse ImportingNon-stockedProductsIntoRq() throws IOException {
    ...
    <div role="tabpanel" class="tab-pane" id="ruby-importing-non-stocked-products-into-rq">
        This code sample uses <a href="https://github.com/rest-client/rest-client">rest-client</a>, ensure you <code>gem install rest-client</code>.
<pre id="ruby-code-importing-non-stocked-products-into-rq"><code class="language-ruby">require 'rest-client'
...
<h3 id='importing-non-revenue-products-into-rq' class='clickable-header top-level-header'>Importing Non-Revenue Products into RQ</h3>
...
<ul class="nav nav-tabs">
    <li class="active"><a href="#http-importing-non-revenue-products-into-rq" data-toggle="tab">HTTP</a></li>
    <li><a href="#curl-importing-non-revenue-products-into-rq" data-toggle="tab">cURL</a></li>
    <li><a href="#csharp-importing-non-revenue-products-into-rq" data-toggle="tab">C# (RestSharp)</a></li>
    <li><a href="#java-importing-non-revenue-products-into-rq" data-toggle="tab">Java (HttpComponents)</a></li>
    <li><a href="#ruby-importing-non-revenue-products-into-rq" data-toggle="tab">Ruby (rest-client)</a></li>
    <button id="copy-importing-non-revenue-products-into-rq" class="copy-button btn btn-default btn-sm" data-clipboard-action="copy" data-clipboard-target="#http-code-importing-non-revenue-products-into-rq"><i class="fa fa-clipboard" title="Copy to Clipboard"></i></button>
</ul>
<div class="tab-content"> 
    <div role="tabpanel" class="tab-pane active" id="http-importing-non-revenue-products-into-rq">
<pre id="http-code-importing-non-revenue-products-into-rq"><code class="language-http">POST /companies(1)/Products/
Authorization: Bearer (Access Token)
Accept: application/json
Content-Type: application/json
</code><code class="language-csharp">{
    ...
    <div role="tabpanel" class="tab-pane" id="curl-importing-non-revenue-products-into-rq">
<pre id="curl-code-importing-non-revenue-products-into-rq"><code class="language-http">curl -X POST "https://platformepcdemo.iqmetrix.net/v1/companies(1)/Products/" -H "Authorization: Bearer (Access Token)" -H "Accept: application/json" -H "Content-Type: application/json" -d '{
    "NonRevenueProducts": [
        {
            "ProductName": "Recycling Fee",
            "CategoryName": "Misc > Misc. Fees",
    ...
    <div role="tabpanel" class="tab-pane" id="csharp-importing-non-revenue-products-into-rq">
        This code sample uses <a href="http://restsharp.org/">RestSharp</a>, ensure you install the nuget package and include <code>Using RestSharp;</code> at the top of your file.
<pre id="csharp-code-importing-non-revenue-products-into-rq"><code class="language-csharp">static IRestResponse ImportingNon-revenueProductsIntoRq()
{
    var client = new RestClient("https://platformepcdemo.iqmetrix.net/v1/companies(1)/Products/");
    var request = new RestRequest(Method.POST);
    ...
    <div role="tabpanel" class="tab-pane" id="java-importing-non-revenue-products-into-rq">
        This code sample uses <a href="https://hc.apache.org/">Apache HttpComponents</a>, ensure you download and include the required Jars.
<pre id="java-code-importing-non-revenue-products-into-rq"><code class="language-java">import org.apache.http.entity.StringEntity;
import org.apache.http.client.methods.CloseableHttpResponse;
import org.apache.http.client.methods.HttpPost;
import org.apache.http.impl.client.CloseableHttpClient;
import org.apache.http.impl.client.HttpClients;
...
public static CloseableHttpResponse ImportingNon-revenueProductsIntoRq() throws IOException {
    ...
    <div role="tabpanel" class="tab-pane" id="ruby-importing-non-revenue-products-into-rq">
        This code sample uses <a href="https://github.com/rest-client/rest-client">rest-client</a>, ensure you <code>gem install rest-client</code>.
<pre id="ruby-code-importing-non-revenue-products-into-rq"><code class="language-ruby">require 'rest-client'
...
<h3 id='importing-vendor-rebates-into-rq' class='clickable-header top-level-header'>Importing Vendor Rebates into RQ</h3>
...
<ul class="nav nav-tabs">
    <li class="active"><a href="#http-importing-vendor-rebates-into-rq" data-toggle="tab">HTTP</a></li>
    <li><a href="#curl-importing-vendor-rebates-into-rq" data-toggle="tab">cURL</a></li>
    <li><a href="#csharp-importing-vendor-rebates-into-rq" data-toggle="tab">C# (RestSharp)</a></li>
    <li><a href="#java-importing-vendor-rebates-into-rq" data-toggle="tab">Java (HttpComponents)</a></li>
    <li><a href="#ruby-importing-vendor-rebates-into-rq" data-toggle="tab">Ruby (rest-client)</a></li>
    <button id="copy-importing-vendor-rebates-into-rq" class="copy-button btn btn-default btn-sm" data-clipboard-action="copy" data-clipboard-target="#http-code-importing-vendor-rebates-into-rq"><i class="fa fa-clipboard" title="Copy to Clipboard"></i></button>
</ul>
<div class="tab-content"> 
    <div role="tabpanel" class="tab-pane active" id="http-importing-vendor-rebates-into-rq">
<pre id="http-code-importing-vendor-rebates-into-rq"><code class="language-http">POST /Companies(1)/products
Authorization: Bearer (Access Token)
Accept: application/json
Content-Type: application/json
</code><code class="language-csharp">{
    ...
    <div role="tabpanel" class="tab-pane" id="curl-importing-vendor-rebates-into-rq">
<pre id="curl-code-importing-vendor-rebates-into-rq"><code class="language-http">curl -X POST "https://platformepcdemo.iqmetrix.net/v1/Companies(1)/products" -H "Authorization: Bearer (Access Token)" -H "Accept: application/json" -H "Content-Type: application/json" -d '{
    "VendorRebateProducts": [
        {
            "VendorName": "SampleVendor",
            "ProductName": "2 YR New Act",
    ...
    <div role="tabpanel" class="tab-pane" id="csharp-importing-vendor-rebates-into-rq">
        This code sample uses <a href="http://restsharp.org/">RestSharp</a>, ensure you install the nuget package and include <code>Using RestSharp;</code> at the top of your file.
<pre id="csharp-code-importing-vendor-rebates-into-rq"><code class="language-csharp">static IRestResponse ImportingVendorRebatesIntoRq()
{
    var client = new RestClient("https://platformepcdemo.iqmetrix.net/v1/Companies(1)/products");
    var request = new RestRequest(Method.POST);
    ...
    <div role="tabpanel" class="tab-pane" id="java-importing-vendor-rebates-into-rq">
        This code sample uses <a href="https://hc.apache.org/">Apache HttpComponents</a>, ensure you download and include the required Jars.
<pre id="java-code-importing-vendor-rebates-into-rq"><code class="language-java">import org.apache.http.entity.StringEntity;
import org.apache.http.client.methods.CloseableHttpResponse;
import org.apache.http.client.methods.HttpPost;
import org.apache.http.impl.client.CloseableHttpClient;
import org.apache.http.impl.client.HttpClients;
...
public static CloseableHttpResponse ImportingVendorRebatesIntoRq() throws IOException {
    ...
    <div role="tabpanel" class="tab-pane" id="ruby-importing-vendor-rebates-into-rq">
        This code sample uses <a href="https://github.com/rest-client/rest-client">rest-client</a>, ensure you <code>gem install rest-client</code>.
<pre id="ruby-code-importing-vendor-rebates-into-rq"><code class="language-ruby">require 'rest-client'
...
<h3 id='getting-status-for-a-batch' class='clickable-header top-level-header'>Getting Status for a Batch</h3>
...
<ul class="nav nav-tabs">
    ...
    <button id="copy-getting-status-for-a-batch" class="copy-button btn btn-default btn-sm" data-clipboard-action="copy" data-clipboard-target="#http-code-getting-status-for-a-batch"><i class="fa fa-clipboard" title="Copy to Clipboard"></i></button>
</ul>
<div class="tab-content"> 
    <div role="tabpanel" class="tab-pane active" id="http-getting-status-for-a-batch">
<pre id="http-code-getting-status-for-a-batch"><code class="language-http">GET /companies(1)/batchStatus(3)
Authorization: Bearer (Access Token)
Accept: application/json
</code><code class="language-csharp"></code></pre>
    </div>
    <div role="tabpanel" class="tab-pane" id="curl-getting-status-for-a-batch">
<pre id="curl-code-getting-status-for-a-batch"><code class="language-http">curl -X GET "https://platformepcdemo.iqmetrix.net/v1/companies(1)/batchStatus(3)" -H "Authorization: Bearer (Access Token)" -H "Accept: application/json"</code></pre>
    </div>
...
<h3 id='getting-all-batches' class='clickable-header top-level-header'>Getting All Batches</h3>
...
<ul class="nav nav-tabs">
    <li class="active"><a href="#http-getting-all-batches" data-toggle="tab">HTTP</a></li>
    <li><a href="#curl-getting-all-batches" data-toggle="tab">cURL</a></li>
    <li><a href="#csharp-getting-all-batches" data-toggle="tab">C# (RestSharp)</a></li>
    <li><a href="#java-getting-all-batches" data-toggle="tab">Java (HttpComponents)</a></li>
    <li><a href="#ruby-getting-all-batches" data-toggle="tab">Ruby (rest-client)</a></li>
    <button id="copy-getting-all-batches" class="copy-button btn btn-default btn-sm" data-clipboard-action="copy" data-clipboard-target="#http-code-getting-all-batches"><i class="fa fa-clipboard" title="Copy to Clipboard"></i></button>
</ul>
<div class="tab-content"> 
    <div role="tabpanel" class="tab-pane active" id="http-getting-all-batches">
<pre id="http-code-getting-all-batches"><code class="language-http">GET /companies(1)/batchStatus
Authorization: Bearer (Access Token)
Accept: application/json
</code><code class="language-csharp"></code></pre>
    </div>
    <div role="tabpanel" class="tab-pane" id="curl-getting-all-batches">
<pre id="curl-code-getting-all-batches"><code class="language-http">curl -X GET "https://platformepcdemo.iqmetrix.net/v1/companies(1)/batchStatus" -H "Authorization: Bearer (Access Token)" -H "Accept: application/json"</code></pre>
    </div>
    <div role="tabpanel" class="tab-pane" id="csharp-getting-all-batches">
        This code sample uses <a href="http://restsharp.org/">RestSharp</a>, ensure you install the nuget package and include <code>Using RestSharp;</code> at the top of your file.
<pre id="csharp-code-getting-all-batches"><code class="language-csharp">static IRestResponse GettingAllBatches()
{
    ...
    <div role="tabpanel" class="tab-pane" id="java-getting-all-batches">
        This code sample uses <a href="https://hc.apache.org/">Apache HttpComponents</a>, ensure you download and include the required Jars.
<pre id="java-code-getting-all-batches"><code class="language-java">
import org.apache.http.client.methods.CloseableHttpResponse;
import org.apache.http.client.methods.HttpGet;
import org.apache.http.impl.client.CloseableHttpClient;
import org.apache.http.impl.client.HttpClients;
...
public static CloseableHttpResponse GettingAllBatches() throws IOException {
    ...
    <div role="tabpanel" class="tab-pane" id="ruby-getting-all-batches">
        This code sample uses <a href="https://github.com/rest-client/rest-client">rest-client</a>, ensure you <code>gem install rest-client</code>.
<pre id="ruby-code-getting-all-batches"><code class="language-ruby">require 'rest-client'
