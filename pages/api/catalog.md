...
<h3 id='getting-catalog-items-by-subscription-list' class='clickable-header top-level-header'>Getting Catalog Items By Subscription List</h3>
...
<ul>
    ...
    <li>
        <code>VendorIds</code> (Optional)  - List of comma seperated integers representing identifiers for <a href='http://developers.iqmetrix.com/api/epc/#vendor'>Vendors</a>
    </li>
    ...
    <li>
        <code>ColorTagIds</code> (Optional)  - Array of integers representing identifiers for <a href='http://developers.iqmetrix.com/api/product-structure/#colortag'>ColorTags</a>
    </li>
