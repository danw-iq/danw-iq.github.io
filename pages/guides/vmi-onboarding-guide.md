...
<br />
**Figure 1:** Illustrates the suggested flow for processing a VMI order.
<img title="dropship pos flow diagram" src="{{ "/images/vmi-flow.png" | prepend: site.url }}" />
